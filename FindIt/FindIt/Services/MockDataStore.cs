...
[assembly: Dependency(typeof(FindIt.Services.MockDataStore))]
	...
	public class MockDataStore : IDataStore<Item>
	{
		...
		public async Task InitializeAsync()
		{
			...
			var _items = new List<Item>
			{
				...
				new Item { Id = Guid.NewGuid().ToString(), Text = "snacks" },
				new Item { Id = Guid.NewGuid().ToString(), Text = "Tripple As" },
			};
